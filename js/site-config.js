...
(function () {
  const SITE_URLS = {
    ...
    company:"https://tom981105-web.github.io/STONK-Company/",
  ...
  window.SiteConfig = {
    ...
    getCurrentRoomCode,
    buildSiteUrl,
    buildHomeUrl: (room) => buildSiteUrl("home", { room }),
    buildBattleUrl: (room) => buildSiteUrl("battle", { room }),
    buildArcadeUrl: (room) => buildSiteUrl("arcade", { room }),
    buildGachaUrl: (room) => buildSiteUrl("gacha", { room }),
    buildBankUrl: (room) => buildSiteUrl("bank", { room }),
    buildCompanyUrl: (room) => buildSiteUrl("company", { room }),
